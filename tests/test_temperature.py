...
class Test_Tpot(unittest.TestCase):
    def test_pref_auto(self):
        ...
        """
        self.assertAlmostEqual(m.temperature.Tpot(273.15,100000.), 273.15, delta=0.01)
        self.assertAlmostEqual(m.temperature.Tpot(0.,100000.), 273.15, delta=0.01)
    def test_pref_K(self):
        """
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.Tpot(273.15,100000.,Kelvin=True), 273.15, delta=0.01)
    def test_pref_C(self):
        """
        0°C, 100000 Pa -> 0 °C
        """
        self.assertAlmostEqual(m.temperature.Tpot(0.,100000.,Kelvin=True), 0., delta=0.01)
    def test_pref_hPa(self):
        """
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.Tpot(273.15,1000.,hPa=True), 273.15, delta=0.01)
    def test_750_auto(self):
        """
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.Tpot(293.15,75000.), 318.28, delta=0.03)
        self.assertAlmostEqual(m.temperature.Tpot(20.,75000.), 318.28, delta=0.03)
...
class Test_inv_Tpot(unittest.TestCase):
    def test_pref_auto(self):
        ...
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.inv_Tpot(273.15,100000.), 273.15, delta=0.01)
        self.assertAlmostEqual(m.temperature.inv_Tpot(0.,100000.), 273.15, delta=0.01)
    def test_pref_K(self):
        """
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.inv_Tpot(273.15,100000.,Kelvin=True), 273.15, delta=0.01)
    def test_pref_C(self):
        """
        0°C, 100000 Pa -> 0 °C
        """
        self.assertAlmostEqual(m.temperature.inv_Tpot(0.,100000.,Kelvin=True), 0., delta=0.01)
    def test_pref_hPa(self):
        """
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.inv_Tpot(273.15,1000.,hPa=True), 273.15, delta=0.01)
    def test_750_auto(self):
        """
        273.15 K, 100000 Pa -> 273.15 K
        """
        self.assertAlmostEqual(m.temperature.inv_Tpot(318.28,75000.), 293.15, delta=0.03)
        self.assertAlmostEqual(m.temperature.inv_Tpot(45.13,75000.), 293.15, delta=0.03)
