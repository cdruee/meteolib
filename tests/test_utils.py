...
class Test__only(unittest.TestCase):
  ...
  '''
  def test_types(self):
    self.assertRaises(TypeError, m._utils._only,{'a':None, 'b':None, 'c':None, 'd':None}, 1 ) 
    self.assertRaises(TypeError, m._utils._only,1, ['b'] ) 
  def test_true_list(self):
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c':None, 'd':None}, ['b']) )
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c': 1  , 'd':None}, ['b','c']) )
  def test_true_str(self):
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c':None, 'd':None}, 'b') )
  def test_false_list(self):
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c':None, 'd':None}, ['c']) )
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c': 1  , 'd':None}, ['a','d']) )
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c': 1  , 'd':None}, ['a','b']) )
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c': 1  , 'd':None}, ['b']) )
  def test_false_str(self):
    self.assertRaises(TypeError, m._utils._only({'a':None, 'b': 1  , 'c':None, 'd':None}, 'd') )
